    ...
    return (
        <SectionWrapper>
            ...
            <DeliveryWrapper>
                ...
                <p><strong>Доставку осуществляем по Москве, всем регионам России и ближнему зарубежью.</strong></p>
                <p>Стоимость доставки по Москве – 500р.</p>
                <p>Для постоянных клиентов, а также для заказов стоимостью свыше 5000р. – доставка бесплатная.</p>
